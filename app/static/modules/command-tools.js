...
class CommandManager {
    ...
    /**
     * Extract a command name and applicable arguments from a given input string.
     * 
     * @param {string} inputStr - the string to be parsed into command parameters.
     * @returns {Array} - command name and arguments.
     */
    getCommandParamsFromInput(inputStr) {
        ...
        return [name, args]                                             // return an array with the command name and usable arguments
    }
